...
Using the uploaded suit material as the exact product reference, create a photorealistic Indian female fashion model wearing this exact suit design. Reconstruct the garment faithfully from the reference image. The embroidery, floral motifs, border, colors, fabric texture and design must remain identical to the original product. Do not invent or modify the embroidery. Elegant natural pose, full-body fashion catalogue photograph, minimal premium studio background, realistic Indian ethnic fashion photography, natural skin texture, professional lighting, high-resolution e-commerce image. The clothing must remain the primary focus.
```
