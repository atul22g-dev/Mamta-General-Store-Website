...
- **`site-footer.tsx`** — brand blurb, shop/category link columns, contact placeholders, copyright

All links come from `src/config/navigation.ts`; contact details from
`src/config/site.ts` (placeholders until real business information exists).
